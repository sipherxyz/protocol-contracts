...
contract("ERC721SipherUser minimal", accounts => {
  ...
  beforeEach(async () => {
    ...
    await token.__ERC721SipherUser_init(name, "RARI", "https://ipfs.sipher.com", "https://ipfs.sipher.com", [whiteListProxy], zeroAddress, zeroAddress, { from: tokenOwner });
  });
